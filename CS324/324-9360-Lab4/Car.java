...
public class Car extends Thread {
  ...
  public void run () {
    for (int I=1;  I<= 4; I++) {
      ...
      Synch.mutex.acquire();
      if (Lights.westlight == 0 || Synch.westq > 0) {
    	  System.out.println("Waiting for light west");
    	  Synch.westq++;
    	  Synch.mutex.release();
      ...
      // *** light is red..
      Synch.mutex.acquire();
      if (Lights.eastlight == 0 || Synch.eastq > 0) {
    	  System.out.println("Waiting for light east");
    	  Synch.eastq++;
    	  Synch.mutex.release();
